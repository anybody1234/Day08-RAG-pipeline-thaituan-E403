# Academic Writing Task 2 - Effect of computers and mobile phones on young people's reading and writing skills
...
Task Response (Band 8): generally a very good answer with lots of support. Coherence & Cohesion (Band 6): there are errors in the use of cohesive devices; for example, 'Nevertheless' is used to introduce an additional negative idea rather than contrasting information, and for band 7 and above there should be no such errors. Lexical Resource (Band 8): mostly very good vocabulary but with some errors, such as 'use of social' instead of 'social media'. Grammatical Range and Accuracy (Band 7): mostly very good grammar but with errors, such as 'are being disinterested' instead of 'are disinterested', and incorrect punctuation in 'Indeed. I do.'
