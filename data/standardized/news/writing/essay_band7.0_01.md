# Academic Writing Task 2 - Young people migrating from rural areas to cities for work or study
...
Task Response (Band 7): the question is answered and ideas are supported; the benefits are discussed in the first body paragraph, though the drawbacks would need a bit more discussion. Coherence & Cohesion (Band 7): well organised with a mix of transition signals and some good use of referencing and substitution, though slightly too many transitions are placed in initial position. Lexical Resource (Band 7): a good mix of relevant topic-related vocabulary of reasonably high level and good awareness of collocation. Grammatical Range and Accuracy (Band 7): a good range and mix of complex sentences and forms, though some grammar errors are evident, particularly in the latter part of the essay.
